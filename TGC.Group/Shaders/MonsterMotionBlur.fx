...
//Pixel Shader
float4 ps_main(float3 Texcoord : TEXCOORD0,
    VS_OUTPUT input) : COLOR0
{
    ...
    else
    {
        ...
        //return fvBaseColor;
        return lerp(fvBaseColor, float4(0, 0, 0, 1), 0.85);
    }
    
    //return lerp(colorFinal, float4(1, 0, 0, 1), 0.5);
}
